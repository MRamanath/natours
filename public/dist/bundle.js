        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat("http://localhost:3000", "/api/v1/users/login"),
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "".concat("http://localhost:3000", "/api/v1/users/logout")
            });
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"settings.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? "".concat("http://localhost:3000", "/api/v1/users/password/update") : "".concat("http://localhost:3000", "/api/v1/users/update/self");
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', "User ".concat(type, " updated successfully!"));
            }
...
/* eslint-disable */
var displayMap = function displayMap(locationArray) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmFtYW5hdGgiLCJhIjoiY2tzMzh0cnZ6MHdhdzJ1cnk3bjRnYzhjYiJ9.ressfrKK52mTtuVJc2SdqA';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51JPPo2SCcdcCAqayobAXcfW1xfYM4mS7clfw3HaeFtNqKhSbBavbU6O0CHz9zMliYp9VT2rMVW0xCFVu64rpJRFt002oIMx8hA');
            _context.prev = 1;
            _context.next = 4;
...
if (mapBox) {
  ...
  (0, _mapbox.default)(locationArray);
}

if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _login.login)(loginForm.querySelector('#email').value, loginForm.querySelector('#password').value);
  });
}
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = userDataForm.querySelector('#name').value;
    var email = userDataForm.querySelector('#email').value;
    var photo = userDataForm.querySelector('#photo').files[0];
    var form = new FormData();
    form.append('name', name);
    form.append('email', email);
    form.append('photo', photo);
    (0, _settings.default)(form, 'profile');
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordCurrent = userPasswordForm.querySelector('#password-current').value;
              password = userPasswordForm.querySelector('#password').value;
              passwordConfirm = userPasswordForm.querySelector('#password-confirm').value;
              _context.next = 7;
            ...
            case 7:
              ...
              userPasswordForm.querySelectorAll('input').forEach(function (el) {
                el.value = '';
              });
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 4;
              return (0, _stripe.default)(tourId);
